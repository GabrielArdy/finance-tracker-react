...
const expenseCategories = [
  { id: 1, name: 'Operasional Gereja' },
  { id: 2, name: 'Gaji Staff' },
  { id: 3, name: 'Utilitas (Listrik, Air, dll)' },
  { id: 4, name: 'Perawatan Bangunan' },
  { id: 5, name: 'Kegiatan Pelayanan' },
  { id: 6, name: 'Misi & Bantuan Sosial' },
  { id: 7, name: 'Inventaris' },
  { id: 8, name: 'Lainnya' }
];
...
export default function ExpenseForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.isConfirmed) {
      ...
      Swal.fire({
        title: 'Berhasil!',
        text: 'Data pengeluaran telah disimpan',
        icon: 'success',
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-red-500 to-red-600 p-6">
              ...
              <p className="text-red-100 mt-1">Formulir pencatatan pengeluaran keuangan gereja</p>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    className={`w-full p-3 border rounded-lg focus:ring focus:ring-red-300 focus:border-red-500 outline-none transition text-gray-800 ${
                ...
                <div className="form-group">
                  ...
                  <div className="relative">
                    <select
                      ...
                      onChange={handleChange}
                      className={`w-full p-3 border rounded-lg appearance-none focus:ring focus:ring-red-300 focus:border-red-500 outline-none transition text-gray-800 bg-white ${
                ...
                <div className="form-group">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="0"
                      className={`w-full p-3 pl-10 border rounded-lg focus:ring focus:ring-red-300 focus:border-red-500 outline-none transition text-gray-800 ${
                ...
                <div className="form-group">
                  <label className="block text-gray-700 font-medium mb-2">
                    <div className="flex items-center">
                      <FaStickyNote className="text-red-500 mr-2" />
                      Keterangan
                    </div>
                  </label>
                  <textarea
                    ...
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-red-300 focus:border-red-500 outline-none transition text-gray-800"
                  ></textarea>
                </div>
          ...
          <div className="mt-6 bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-start">
              <div className="flex-shrink-0">
                <FaCheckCircle className="text-red-500 mt-0.5" />
              </div>
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">Tips pencatatan pengeluaran</h3>
                <div className="mt-2 text-sm text-red-700 space-y-1">
                  <p>• Simpan bukti pengeluaran seperti nota atau kuitansi</p>
                  <p>• Pilih kategori yang tepat untuk pelaporan yang lebih baik</p>
                  <p>• Tambahkan keterangan lengkap untuk transparansi</p>
                </div>
              </div>
            </div>
          </div>
